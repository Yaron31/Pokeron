...
const translations = {
  fr: {
    ...
    mustSendPokemon: "Tu dois envoyer un Pokémon !",
    sendWhichPokemon: "Quel Pokémon envoyer ?",
    ...
    confirmSwitch: "Envoyer {name} ? (clique à nouveau)",
    manageTeam: "Équipe",
    manageTeamPrompt: "Clique sur un Pokémon pour le déplacer.",
    swapWith: "Échanger {name} avec...",
    done: "TERMINÉ",
    cancel: "ANNULER"
  },
  en: {
    ...
    mustSendPokemon: "You must send a Pokémon!",
    sendWhichPokemon: "Which Pokémon to send?",
    ...
    confirmSwitch: "Send {name}? (click again)",
    manageTeam: "Team",
    manageTeamPrompt: "Click a Pokémon to move it.",
    swapWith: "Swap {name} with...",
    done: "DONE",
    cancel: "CANCEL"
  }
};
